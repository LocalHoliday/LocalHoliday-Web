...
export default function SearchPlayMap({ lat, lng }: SearchPlayMapProps) {
  console.log(lat, lng)
  useEffect(() => {
    ...
    mapScript.src = `//dapi.kakao.com/v2/maps/sdk.js?appkey=4fea8d71ddd17d417dc24316314e373d&autoload=false`
